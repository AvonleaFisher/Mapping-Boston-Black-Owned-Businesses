...
| Restaurants | Stores |
| --- | --- |
| <img src ='https://github.com/AvonleaFisher/Mapping-Boston-Black-Owned-Businesses/blob/main/Images/favpng_font-awesome-cutlery-fork-tableware.png' width="70" height="100" alt="Restaurants"></a>| <img src ='https://github.com/AvonleaFisher/Mapping-Boston-Black-Owned-Businesses/blob/main/Images/stores_dollar.png' width="70" height="100" alt="Stores"></a> || git diff | Show file differences that haven't been staged |
